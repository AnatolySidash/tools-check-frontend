   ...
   addTool(tool) {
      return fetch(`${this._baseUrl}/tools`, {
         ...
         body: JSON.stringify({
            ...
            "toolReceiveDate": tool.toolReceiveDate,
            "toolCheckDate": tool.toolCheckDate,
            "toolReadyDate": tool.toolReadyDate,
            "toolReleaseDate": tool.toolReleaseDate,
            ...
            "toolCheckCost": tool.toolCheckCost,
            "toolAvailability": tool.toolAvailability,
            "toolWorkability": tool.toolWorkability,
            "toolDocAvailability": tool.toolDocAvailability,
